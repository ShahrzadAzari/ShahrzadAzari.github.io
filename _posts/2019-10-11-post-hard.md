...
var disqus_config = function () {
    this.page.url = https://shahrzadazari.github.io/post-hard;  // Replace PAGE_URL with your page's canonical URL variable
    this.page.identifier = hard; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
};
*/
